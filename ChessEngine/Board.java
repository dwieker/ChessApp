...
public class Board{
   ...
   public void setup(String FEN){
      ...
      while(true){
         if(FEN.charAt(i) == '/' ){ row--; col = 0;}
            ...
            else if(FEN.charAt(i) == 'k') temp = bKing = new King('b', row*16 + col);
            else if(FEN.charAt(i) == 'K') temp = wKing = new King('w', row*16 + col);
            else{
                temp = null;
   ...
   public void unmovePiece(MoveHistory mh){
   ...
   public Piece checkSquare(int r, int c){
      return squares[r * 16 + c];
   }
